  ...
  return (
    <div className="h-[100dvh] font-sans max-w-md mx-auto relative overflow-hidden flex flex-col bg-sky-50">
      ...
      <div className="flex-1 overflow-hidden flex flex-col relative">
        ...
        {(gameState === 'shopping' || gameState === 'english_interaction') && ['mission_00', 'mission_A2', 'mission_A3'].includes(activeMission.id) && (
        ...
        {/* STATE: SHOPPING */}
        {gameState === 'shopping' && !['mission_00', 'mission_A2', 'mission_A3'].includes(activeMission.id) && (
        ...
        {gameState === 'english_interaction' && !['mission_00', 'mission_A2', 'mission_A3'].includes(activeMission.id) && (
