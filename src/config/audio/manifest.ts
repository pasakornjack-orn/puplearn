...
export const mission00Audio: AudioAsset[] = [
  { id: 'mission00.instruction', character: 'bingo', voiceId: VOICES.bingo, text: 'ช่ใย Bingo หาแอปเปิลหน่อศ!', output: '/audio/bingo/mission00/instruction.mp3' },
  { id: 'mission00.wrong_banana', character: 'bingo', voiceId: VOICES.bingo, text: 'นี่คือกล้วย ลองหาชิ้นอื่นดูนั', output: '/audio/bingo/mission00/wrong-banana.mp3' },
  ...
  { id: 'mission00.wrong_toothbrush', character: 'bingo', voiceId: VOICES.bingo, text: 'นี่คือแปรงสีฟัน ลองหาชิ้นอื่นดูนั', output: '/audio/bingo/mission00/wrong-toothbrush.mp3' },
  ...
  { id: 'pillow.repeat', character: 'pillow', voiceId: VOICES.pillow, text: 'พูดตาษ Pillow นะ...', output: '/audio/pillow/shared/repeat.mp3' },
